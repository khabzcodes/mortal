        ...
        {!error && !!message && (
          <>
            ...
            <div className="flex max-h-80">
              <ScrollArea className="prose dark:prose-invert prose-headings:mt-0 min-w-full mb-6 prose-pre:rounded-md prose-pre:bg-gray-800 dark:prose-pre:bg-gray-900">
